...
describe('postgres-code-generator', () => {
	...
	it('select01 - select id, name from mytable2 where id = ?', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select01.ts.txt');
	...
	it('select02 - select without parameters', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select02.ts.txt');
	...
	it('select03 - select with same parameter used twice', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select03.ts.txt');
	...
	it('select05 - SELECT id FROM mytable1 ORDER BY ?', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select05.ts.txt');
...
AND name IN (:names)`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select06.ts.txt');
...
OR name = $3`;
		...
		const actual = await generateCode(dialect, sql, 'select06', schemaInfo);
		const expected = readNormalizedEOL('tests/postgres/expected-code/select06-2.ts.txt');
...
AND name <> :name`;
		...
		const actual = await generateCode(dialect, sql, 'select06', schemaInfo);
		const expected = readNormalizedEOL('tests/postgres/expected-code/select06-any.ts.txt');
...
WHERE :param1 is true OR (:param2 is true OR :param2::bool is null)`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select08.ts.txt');
...
where enum_column = :enum_value`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select09-enum.ts.txt');
...
where enum_constraint = :enum_value`;
		...
		const actual = await generateCode(dialect, sql, 'select09', schemaInfo);
		const expected = readNormalizedEOL('tests/postgres/expected-code/select09-enum-constraint.ts.txt');
	...
	it('select-type-cast ', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-type-cast.ts.txt');
...
LEFT JOIN roles r on t1.id = r.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select11.ts.txt');
	...
	it('insert01 - INSERT INTO mytable1(value) values(10)', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/insert01.ts.txt');
	...
	it('insert02 - select with same parameter used twice', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/insert02.ts.txt');
	...
	it('insert03 - INSERT INTO mytable1(value) VALUES(:value) RETURNING *', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/insert03.ts.txt');
	...
	it('insert04-default - INSERT INTO all_types(integer_column_default) VALUES (:value)', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/insert04-default.ts.txt');
	...
	it('insert05-default-not-null - INSERT INTO roles(role) VALUES (:role)', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/insert05.ts.txt');
	...
	it('update01 - UPDATE mytable1 SET value=? WHERE id=?', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/update01.ts.txt');
	...
	it('update02 - update-no-data - UPDATE with no SET parameters should not include data parameter', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/update02.ts.txt');
	...
	it('delete01 - DELETE FROM mytable1 WHERE id=?', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/delete01.ts.txt');
	...
	it('crud-select01', () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-select01.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-select02 - select-id-serial', () => {
		const actual = generateCrud('Select', 'roles', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-select02.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-insert01', () => {
		const actual = generateCrud('Insert', 'mytable1', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-insert01.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-insert02-default-not-null', async () => {
		const actual = generateCrud('Insert', 'roles', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-insert02.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-update01', () => {
		const actual = generateCrud('Update', 'mytable1', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-update01.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-update02', () => {
		const actual = generateCrud('Update', 'mytable2', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-update02.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-update03 - not null', () => {
		const actual = generateCrud('Update', 'mytable3', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-update03.ts.txt');
		assert.deepStrictEqual(actual, expected);
	});

	it('crud-delete01', () => {
		const actual = generateCrud('Delete', 'mytable1', schemaInfo.columns);
		const expected = readNormalizedEOL('tests/postgres/expected-code/crud-delete01.ts.txt');
...
INNER JOIN posts p on p.fk_user = u.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/nested01.ts.txt');
...
WHERE c.id = :clientId`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/nested02-clients-with-addresses.ts.txt');
...
INNER JOIN users u on u.id = p.fk_user`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/nested03-many-to-many.ts.txt');
	...
	INNER JOIN mytable2 m2 on m1.id = m2.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query01.ts.txt');
...
INNER JOIN ( -- derivated table
	...
	WHERE m.name = :subqueryName
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query02.ts.txt');
	...
	FROM mytable1 t1`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query03.ts.txt');
	...
	INNER JOIN mytable2 m2 on m2.id = m1.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query04.ts.txt');
...
INNER JOIN cte m2 on m2.id = m1.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query05.ts.txt');
	...
	ORDER BY :orderBy`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query06.ts.txt');
	...
	ORDER BY :sort`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query07.ts.txt');
...
WHERE EXTRACT(YEAR FROM timestamp_not_null_column) = :param1 AND EXTRACT(MONTH FROM timestamp_not_null_column) = :param2`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query08-date.ts.txt');
	...
	INNER JOIN mytable3 t3 on t3.id = t2.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query09.ts.txt');
	...
	LIMIT :limit OFFSET :offset`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query10.ts.txt');
...
INNER JOIN cte2 c2 on c1.id = c2.id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query11.ts.txt');
	...
	it('dynamic-query-13-enum', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/dynamic-query13-enum.ts.txt');
	...
	it('copy01', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/copy01.ts.txt');
	...
	it('copy02', async () => {
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/copy02.ts.txt');
...
FROM (
	VALUES
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json01.ts.txt');
...
GROUP BY id`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json02.ts.txt');
	...
	jsonb_build_array(null, 'c', 10) as value2`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json03.ts.txt');
	...
	'list', json_build_array(1, 'a')
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json04.ts.txt');
	...
	'nested', json_build_object (
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json05.ts.txt');
...
group by u.id, u.name`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json06.ts.txt');
...
group by u.id, u.name`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json07.ts.txt');
...
group by u.id, u.name`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json08.ts.txt');
...
FROM mytable2`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json09.ts.txt');
...
FROM mytable1`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json10.ts.txt');
...
FROM mytable1 t`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json11.ts.txt');
...
FROM all_types t`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json12.ts.txt');
...
GROUP BY int4_column`;
		...
		const expected = readNormalizedEOL('tests/postgres/expected-code/select-json13.ts.txt');
